...
tableManager.attributes = ['num', 'name', 'type' ,'weaknesses', 'next_evolution', 'prev_evolution', 'img'];
...
tableManager.addObjectAttribute('prev_evolution', 'name');
tableManager.imageAttributes = ['img'];
tableManager.make();
